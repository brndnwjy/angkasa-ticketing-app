            ...
            <div className={`${styles.card2} card-body`}>
              ...
              <div className={styles.back}>
                ...
                <img
                  ...
                  src={require("../../assets/btnback.png")}
                  alt="btnback"
                />
              </div>
              ...
              <div className={styles.buttonContainer}>
                <button
                  className={`${styles.submit1} btn btn-primary`}
                  type="submit"
                >
                  One way
                </button>
                ...
                <button
                  className={`${styles.submit2} btn btn-light text-dark`}
                  type="submit"
                >
                  Round trip
                </button>
              ...
              <div className={styles.departure}>
                <h6>Departure</h6>
                <select
                  className={`${styles.dep} form-select`}
              ...
              <div className={styles.person}>
                ...
                <select
                  className={`${styles.child} form-select`}
                  aria-label="Default select example"
                >
                  <option selected>2 Child</option>
                </select>
                <select
                  className={`${styles.adult1} form-select`}
                  aria-label="Default select example"
                >
              ...
              <div className={styles.which}>
                ...
                <div className={styles.button}>
                  <button className={`${styles.btnSF} btn btn-primary `}>
                    SEARCH FLIGHT
                  </button>
                </div>
              </div>
