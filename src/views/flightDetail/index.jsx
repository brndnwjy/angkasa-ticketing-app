...
const FlightDetail = () => {
 ...
 if(dataFlight.arrival_time===0){
  ...
  const handleSubmit=((e)=>{
    if(bookingform.psg_title!==""||bookingform.psg_name!==""||bookingform.psg_nationality!==""){
    e.preventDefault();
            ...
            <div className="row">
              ...
              <div className={`col-md-4 p-4 ${styles.rightside}`}>
                ...
                <div className="d-flex flex-row mt-4">
                  <div className={styles.textCity}>{dataFlight.arrival_city} ({dataFlight.arrival_country})</div>
                  <img src={icFlight} alt="flight" className="mx-4" />
                  <div className={styles.textCity}>{dataFlight.departure_city}  ({dataFlight.departure_country})</div>
                </div>
                <div className="d-flex flex-row mt-4">
                  <div className={styles.textTime}>Sunday, 15 August 2020</div>
                  <img src={icDot} alt="dot" className="mx-3" />
                  <div className={styles.textTime}>{jamDatang} - {JamSampe}</div>
                </div>
                <div className="d-flex flex-row mt-4">
