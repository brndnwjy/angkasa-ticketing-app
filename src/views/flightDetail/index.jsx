          ...
          <div className="row">
            <div className={`col-md-8 p-4 ${styles.leftside}`}>
              <div className={`p-4 ${styles.CPdetail}`}>
                <div className="d-flex flex-column">
                  ...
                  <div className="input-group mb-4">
                    <input type="text" className={`form-control ${styles.inputStyle}`} placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" />
                  </div>
                  <p className={styles.textLabelCP}>Email</p>
                  <div className="input-group mb-4">
                    <input type="email" className={`form-control ${styles.inputStyle}`} placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" />
                  </div>
                  <p className={styles.textLabelCP}>Phone Number</p>
                  <div className="input-group mb-4">
                    <input type="text" className={`form-control ${styles.inputStyle}`} placeholder="Phone" aria-label="Phone" aria-describedby="basic-addon1" />
                  </div>
              ...
              <div className={`p-4 ${styles.passengerDetail}`}>
                ...
                <div className="d-flex flex-column">
                  ...
                  <div className="input-group mb-4">
                    <input type="text" className={`form-control ${styles.inputStyle}`} placeholder="Mr" aria-label="Mr" aria-describedby="basic-addon1" />
                  </div>
                  <p className={styles.textLabelCP}>Full Name</p>
                  <div className="input-group mb-4">
                    <input type="text" className={`form-control ${styles.inputStyle}`} placeholder="FullName" aria-label="FullName" aria-describedby="basic-addon1" />
                  </div>
                  <p className={styles.textLabelCP}>Nationallity</p>
                  <div className="input-group mb-4">
                    <input type="text" className={`form-control ${styles.inputStyle}`} placeholder="Nationallity" aria-label="Nationallity" aria-describedby="basic-addon1" />
                  </div>
            ...
            <div className={`col-md-4 p-4 ${styles.rightside}`}>
              ...
              <div className="d-flex flex-row mt-3">
                ...
                <div className={`ms-auto me-3 ${styles.textPrice}`}>$ 145,00</div>
